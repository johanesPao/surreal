...
export async function createComment(data: string): Promise<InsertComment> {
  ...
  const comment: InsertComment = {
    ...
    articleId: insertCommentData.articleId,
    content: JSON.parse(insertCommentData.content),
  };
