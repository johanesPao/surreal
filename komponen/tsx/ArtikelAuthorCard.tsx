...
const ArtikelAuthorCard = () => {
  return (
    <div className='px-[5%] lg:px-[30%] mt-20 ml-16 pt-5'>
      <div className='relative w-full bg-slate-900 rounded-tl-md rounded-tr-3xl rounded-bl-3xl rounded-br-md p-10 shadow-xl flex flex-col items-start gap-5'>
        <Image
        ...
        />
        <p className='text-stone-300 text-sm first-letter:text-[20px] backdrop-invert-0 mix-blend-difference'>
