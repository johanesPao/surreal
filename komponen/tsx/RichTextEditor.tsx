...
type RichTextEditorProps = {
  ...
  postButtonState: Signal<boolean>;
  limit: number;
};

const warning = signal<"text-green-500" | "text-orange-500" | "text-red-500">(
  "text-green-500",
);
...
const RichTextEditor = ({
  ...
  const editor = useEditor({
    ...
    onUpdate: ({ editor }) => {
      ...
      postButtonState.value = !editor.isEmpty;
    },
  });
  ...
  //     JSON.stringify(insertCommentData),
  //   );
  ...
  return (
    <div className="flex gap-2 h-full overflow-y-scroll">
      <div className="flex flex-col gap-1 text-[0.8rem] overflow-y-scroll no-scrollbar w-fit px-1">
        <div
          className={`${editor.isActive("bold") ? "bg-green-700" : "bg-stone-700"} rounded-md p-1`}
        >
          <IconBold
            size={32}
        ...
        <div
          className={`${editor.isActive("italic") ? "bg-green-700" : "bg-stone-700"} rounded-md p-1`}
        >
          <IconItalic
            size={32}
        ...
        <div
          className={`${editor.isActive("strike") ? "bg-green-700" : "bg-stone-700"} rounded-md p-1`}
        >
          <IconStrikethrough
            size={32}
        ...
        <div
          className={`${editor.isActive("underline") ? "bg-green-700" : "bg-stone-700"} rounded-md p-1`}
        >
          <IconUnderline
            size={32}
        ...
        <div
          className={`${editor.isActive("subscript") ? "bg-green-700" : "bg-stone-700"} rounded-md p-1`}
        >
          <IconSubscript
            size={32}
        ...
        <div
          className={`${editor.isActive("superscript") ? "bg-green-700" : "bg-stone-700"} rounded-md p-1`}
        >
          <IconSuperscript
            size={32}
        ...
        <div
          className={`${editor.isActive("highlight") ? "bg-green-700" : "bg-stone-700"} rounded-md p-1`}
        >
          <IconHighlight
            size={32}
        ...
        <div
          className={`${editor.isActive("code") ? "bg-green-700" : "bg-stone-700"} rounded-md p-1`}
        >
          <IconCode
            size={32}
          ...
          {editor && (
            <FloatingMenu editor={editor} tippyOptions={{ duration: 100 }}>
              <div className="floating-menu flex bg-stone-700 gap-1 rounded-md p-2">
                <div
                  className={`${editor.isActive("heading", { level: 1 }) ? "bg-green-700" : "bg-stone-700"} rounded-md p-1`}
                >
                  <IconH1
                    onClick={() =>
                ...
                <div
                  className={`${editor.isActive("heading", { level: 2 }) ? "bg-green-700" : "bg-stone-700"} rounded-md p-1`}
                >
                  <IconH2
                    onClick={() =>
                ...
                <div
                  className={`${editor.isActive("heading", { level: 3 }) ? "bg-green-700" : "bg-stone-700"} rounded-md p-1`}
                >
                  <IconH3
                    onClick={() =>
                ...
                <div
                  className={`${editor.isActive("bulletList") ? "bg-green-700" : "bg-stone-700"} rounded-md p-1`}
                >
                  <IconList
                    onClick={() =>
